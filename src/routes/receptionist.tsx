  ...
  return (
    <div className="min-h-screen bg-muted/30">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        <div className="rounded-xl border bg-card flex flex-col h-[calc(100vh-9rem)]">
                ...
                <div className="flex flex-wrap gap-2 pl-11">
                  {quickPrompts.map((p) => (
                    <button
                      ...
                      className="text-xs rounded-full border px-3 py-1.5 bg-background hover:bg-muted transition"
                    >
                      {p}
                    </button>
                  ))}
